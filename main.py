...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        #about_action.setMenuRole(QAction.MenuRole.NoRole) //Solo en caso de que no se muestre el menu help
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        context= """
        Thies app was created during the course "The Python Mega Course".
...
class DeleteDialog(QDialog):
    ...
    def delete_student(self):
        # Get seleted row index and student id
        index = main_window.table.currentRow()
